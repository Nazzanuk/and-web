	...
	protected function open_file_in_mode( $file, $mode ) {
		...
		if ( false === $file_handle ) {
			...
			throw new Ai1wm_Not_Accesible_Exception(
				__(
					'Unable to open ' . $file . '<br /><br />' .
					'<strong>Possible solutions</strong><br />' .
					'1. Ensure that you have enough disk space on your server.<br />' .
					'2. Ensure that file permissions are correctly set-up - 775 or 777 to <strong>wp-content</strong> directory and all files and folders that it contains.',
					AI1WM_PLUGIN_NAME
				)
			);
		}
