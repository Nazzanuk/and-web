...
<head lang="en">
    ...
    <link rel="stylesheet" href="<?php echo get_theme_root(); ?>/css/bower.css"/>
...
<script src="<?php echo get_template_directory(); ?>/js/bower.js"></script>
<script src="<?php echo get_template_directory(); ?>/js/app.js"></script>
</body>
</html>